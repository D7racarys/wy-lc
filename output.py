...
for item in [course1, course2, course3, course4, course5]:
    for id in range(item.id * 10000 + 1, item.id * 10000 + 91):
        ...
        #获取到勤信息
        if id in item.abStuIds[0]:
            stuClass1 = False
        else:
            stuClass1 = True
        if id in item.abStuIds[1]:
            stuClass2 = False
        else:
            stuClass2 = True
        if id in item.abStuIds[2]:
            stuClass3 = False
        else:
            stuClass3 = True
        if id in item.abStuIds[3]:
            stuClass4 = False
        else:
            stuClass4 = True
        if id in item.abStuIds[4]:
            stuClass5 = False
        else:
            stuClass5 = True
        if id in item.abStuIds[5]:
            stuClass6 = False
        else:
            stuClass6 = True
        if id in item.abStuIds[6]:
            stuClass7 = False
        else:
            stuClass7 = True
        if id in item.abStuIds[7]:
            stuClass8 = False
        else:
            stuClass8 = True
        if id in item.abStuIds[8]:
            stuClass9 = False
        else:
            stuClass9 = True
        if id in item.abStuIds[9]:
            stuClass10 = False
        else:
            stuClass10 = True
        if id in item.abStuIds[10]:
            stuClass11 = False
        else:
            stuClass11 = True
        if id in item.abStuIds[11]:
            stuClass12 = False
        else:
            stuClass12 = True
        if id in item.abStuIds[12]:
            stuClass13 = False
        else:
            stuClass13 = True
        if id in item.abStuIds[13]:
            stuClass14 = False
        else:
            stuClass14 = True
        if id in item.abStuIds[14]:
            stuClass15 = False
        else:
            stuClass15 = True
        if id in item.abStuIds[15]:
            stuClass16 = False
        else:
            stuClass16 = True
        if id in item.abStuIds[16]:
            stuClass17 = False
        else:
            stuClass17 = True
        if id in item.abStuIds[17]:
            stuClass18 = False
        else:
            stuClass18 = True
        if id in item.abStuIds[18]:
            stuClass19 = False
        else:
            stuClass19 = True
        if id in item.abStuIds[19]:
            stuClass20 = False
        else:
            stuClass20 = True
